...
Flight::route('GET /admin/staff', [$internshipController, 'adminStaff']);
Flight::route('POST /admin/staff/create', [$internshipController, 'createManagedStaff']);
Flight::route('POST /admin/staff/@id/update', [$internshipController, 'updateManagedStaff']);
